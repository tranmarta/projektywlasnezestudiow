<p>The task was to create a simple game in PHP with a clickable map using session mechanism to move on virtual ship/house and give a possibility for user to collect inventory.</p>
